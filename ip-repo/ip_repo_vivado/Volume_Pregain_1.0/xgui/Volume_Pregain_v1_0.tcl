...
proc init_gui { IPINST } {
  ...
  set INTBIT_WIDTH [ipgui::add_param $IPINST -name "INTBIT_WIDTH"]
  set_property tooltip {bit-Width of Integer part of gain coefficient. rest of the bits from 32 will be left for fraction part.} ${INTBIT_WIDTH}
