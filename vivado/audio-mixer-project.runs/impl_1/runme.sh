...
HD_PWD='/home/martin.perman/workspace/audio-mixer-project/vivado/audio-mixer-project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_mixer_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_mixer_project_wrapper.tcl -notrace
