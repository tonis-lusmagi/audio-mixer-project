...
HD_PWD='/home/martin.perman/workspace/audio-mixer-project/vivado/audio-mixer-project.runs/audio_mixer_project_mixer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_mixer_project_mixer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_mixer_project_mixer_0_0.tcl
