...
HD_PWD='/home/clarke/workspace/audio-mixer-project/vivado/audio-mixer-project.runs/audio_mixer_project_pmod_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_mixer_project_pmod_controller_0_0.vds -m64 -tempDir /home/clarke/tmp -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_mixer_project_pmod_controller_0_0.tcl
