...
--               /home/clarke/workspace/audio-mixer-project/vivado/audio-mixer-project.srcs/sources_1/bd/audio_mixer_project/ip/audio_mixer_project_pmod_controller_0_1/audio_mixer_project_pmod_controller_0_1_sim_netlist.vhdl
...
entity audio_mixer_project_pmod_controller_0_1_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_debouncer : entity is "debouncer";
end audio_mixer_project_pmod_controller_0_1_debouncer;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_debouncer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1_debouncer_0 is
  port (
    r6_input_reg : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    Switch : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_debouncer_0 : entity is "debouncer";
end audio_mixer_project_pmod_controller_0_1_debouncer_0;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_debouncer_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1_pulse_generator is
  port (
    Rotary_event : out STD_LOGIC;
    Rotary_b : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    result : in STD_LOGIC;
    result_reg : in STD_LOGIC;
    Rotary_a : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_pulse_generator : entity is "pulse_generator";
end audio_mixer_project_pmod_controller_0_1_pulse_generator;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_pulse_generator is
  signal delay1_input : STD_LOGIC;
  signal delay1_input_i_2_n_0 : STD_LOGIC;
  signal delay2_input : STD_LOGIC;
  signal delay2_input0 : STD_LOGIC;
  signal delay3_input : STD_LOGIC;
  signal delay3_input0 : STD_LOGIC;
  signal pulseout_todelay : STD_LOGIC;
...
begin
Rotary_event_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
delay1_input_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF6FF6"
    )
        port map (
...
delay1_input_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
delay1_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => pulseout_todelay,
...
delay2_input_i_1: unisim.vcomponents.LUT6
    generic map(
...
delay2_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => delay2_input0,
...
delay3_input_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EFFEFFFFFFFFEFFE"
    )
        port map (
...
delay3_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => delay3_input0,
...
r2_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => Rotary_b,
...
r3_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => r2_input,
...
r4_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => result,
...
r5_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => r4_input,
...
r6_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => result_reg,
...
r7_input_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => r6_input,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1_rotary_controller is
  port (
    result : out STD_LOGIC;
    r6_input_reg : out STD_LOGIC;
    Rotary_event : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_rotary_controller : entity is "rotary_controller";
end audio_mixer_project_pmod_controller_0_1_rotary_controller;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_rotary_controller is
  signal \^r6_input_reg\ : STD_LOGIC;
  signal \^result\ : STD_LOGIC;
begin
  r6_input_reg <= \^r6_input_reg\;
  result <= \^result\;
Button_debouncer: entity work.audio_mixer_project_pmod_controller_0_1_debouncer
     port map (
      Button => Button,
      result => \^result\,
      s00_axi_aclk => s00_axi_aclk
    );
Switch_debouncer: entity work.audio_mixer_project_pmod_controller_0_1_debouncer_0
     port map (
      Switch => Switch,
      r6_input_reg => \^r6_input_reg\,
      s00_axi_aclk => s00_axi_aclk
    );
pulsegen: entity work.audio_mixer_project_pmod_controller_0_1_pulse_generator
     port map (
      Rotary_a => Rotary_a,
      Rotary_b => Rotary_b,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0_S00_AXI : entity is "pmod_controller_v1_0_S00_AXI";
end audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0_S00_AXI;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0_S00_AXI is
  ...
  signal controller1_n_1 : STD_LOGIC;
...
controller1: entity work.audio_mixer_project_pmod_controller_0_1_rotary_controller
     port map (
      Button => Button,
      Rotary_a => Rotary_a,
      Rotary_b => Rotary_b,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0 : entity is "pmod_controller_v1_0";
end audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0 is
begin
pmod_controller_v1_0_S00_AXI_inst: entity work.audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0_S00_AXI
     port map (
      Button => Button,
      Rotary_a => Rotary_a,
      Rotary_b => Rotary_b,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_mixer_project_pmod_controller_0_1 is
  port (
    Rotary_a : in STD_LOGIC;
    Rotary_b : in STD_LOGIC;
    Button : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of audio_mixer_project_pmod_controller_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of audio_mixer_project_pmod_controller_0_1 : entity is "audio_mixer_project_pmod_controller_0_1,pmod_controller_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of audio_mixer_project_pmod_controller_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of audio_mixer_project_pmod_controller_0_1 : entity is "pmod_controller_v1_0,Vivado 2017.3";
end audio_mixer_project_pmod_controller_0_1;

architecture STRUCTURE of audio_mixer_project_pmod_controller_0_1 is
...
U0: entity work.audio_mixer_project_pmod_controller_0_1_pmod_controller_v1_0
     port map (
      Button => Button,
      Rotary_a => Rotary_a,
      Rotary_b => Rotary_b,
